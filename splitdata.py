...
source_directory = 'renametrain13'  # Replace with your actual source directory

# Directories for the train, test, and validation splits
train_directory = 'dataset2/train'  # Replace with your actual train directory
test_directory = 'dataset2/test'    # Replace with your actual test directory
valid_directory = 'dataset2/valid'  # Replace with your actual validation directory
